...
class ExplicitFunctionFrame: JFrame() {
    ...
    init {
        ...
        var polynom: Newton = Newton(mapOf(0.0 to 0.0))
        var derivative: Polynom = polynom.derivative()
        ...
        var parameterized_function_graphPainter = ParameterizedFunctionPainter(plane, derivative::invoke)
        parameterized_function_graphPainter.funColor = Color.PINK

        var painters = mutableListOf(cartesianPainter, pointsPainter, explicit_function_graphPainter)
        ...
        cb_parameterized_function = JCheckBox("функция, заданная параметрически")
        ...
        controlPanel.layout = GroupLayout(controlPanel).apply {
            ...
            setHorizontalGroup(
                createSequentialGroup()
                    ...
                    .addGroup(
                        createParallelGroup()
                            .addComponent(cb_explicit_function, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
                            .addComponent(cb_parameterized_function, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
                    )
                    .addGap(4)
                    .addGroup(
                        createParallelGroup()
